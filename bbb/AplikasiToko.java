    ...
    private class TombolPenjualanHandler implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (TblPilih == TblJualCustomerDaftar) {
                ...
                int Total = 0, SubTtl, Bayar, Harga, Jumlah;
                ...
                for (i = 0; i < TabelPenjualan.getRowCount(); i++) {
                    try {
                        Harga = Integer.parseInt((String) TabelPenjualan.getModel().getValueAt(i, 3));
                        Jumlah = Integer.parseInt((String) TabelPenjualan.getModel().getValueAt(i, 4));
                        SubTtl = Integer.parseInt((String) TabelPenjualan.getModel().getValueAt(i, 5));
                    } catch (Exception ex) {
                    }
                    Total = Harga + SubTtl;
